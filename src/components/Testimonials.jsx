...
const Testimonails = () => {
  return (
    <div className="container mx-auto py-10 lg:px-32 w-full overflow" id="Testimonials">
     ...
     <div className="flex flex-wrap justify-center gap-8">
       {testimonialsData.map((testimonial, index)=>(
         <div key={index} className="max-w-[340px] border shadow-lg rounded px-8 py-8 text-center">
               <img className="w-20 h-20 rounded-full mx-auto mb-4" src={testimonial.image} alt={testimonial.alt}/>
               <h2 className="text-xl text-gray-7-- font-medium">{testimonial.name}</h2>
